...
<div class="container">
	<div class="main">
		...
		<div class="inline-block">
			<h1>Contact Form</h1>
			<p>8901 Marmora, Glasgow, D04 89GR</p>
			<p class="grey-text">Freephone:<span class="right">+1 800 559 6580</span></p>
			<p class="grey-text">Telephone<span class="right">+1 959 603 6035</span></p>
			<p class="grey-text">FAX:<span class="right">+1 504 889 9898</span></p>
			<p class="grey-text">E-mail:<span class="right"><a href="" class="purple-text">mail@demolink.org</a></span></p>
		</div>
